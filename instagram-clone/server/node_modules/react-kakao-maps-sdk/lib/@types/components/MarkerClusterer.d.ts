...
export declare const KakaoMapMarkerClustererContext: React.Context<kakao.maps.MarkerClusterer>;
export interface MarkerClustererProps {
     ...
     */
    onClusterover?: (target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void;
    /**
     * 클러스터 마커를 마우스 아웃 했을 때 발생한다
     * 이벤트 핸들러 함수 인자로는 마우스 아웃된 Cluster 객체가 넘어온다.
     */
    onClusterout?: (target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void;
    /**
     ...
     */
    onClusterdblclick?: (target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void;
    /**
     * 클러스터 마커를 오른쪽 클릭 했을 때 발생한다
     * 이벤트 핸들러 함수 인자로는 오른쪽 클릭한 Cluster 객체가 넘어온다.
     */
    onClusterrightclick?: (target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void;
    /**
     * 클러스터링이 완료됐을 때 발생한다.
     * 이벤트 핸들러 함수 인자로는 생성된 Cluster 객체 전체가 배열로 넘어온다.
     */
    onClustered?: (target: kakao.maps.MarkerClusterer, clusters: kakao.maps.Cluster[]) => void;
    /**
     * MarkerClusterer 생성 후 해당 객체를 전달하는 함수
     */
    onCreate?: (target: kakao.maps.MarkerClusterer) => void;
}
declare const MarkerClusterer: React.ForwardRefExoticComponent<MarkerClustererProps & {
    children?: React.ReactNode;
} & React.RefAttributes<kakao.maps.MarkerClusterer>>;
