 ...
 * ```
 */
declare const DrawingManager: <T extends kakao.maps.drawing.OverlayType = kakao.maps.drawing.OverlayType>(_props: Partial<kakao.maps.drawing.OverlayOptions> & Pick<kakao.maps.drawing.OverlayOptions, `${T}Options`> & {
    /**
     * 마우스 오버 시 가이드 툴팁 표시 여부. ‘draw’, ‘drag’, ‘edit’ 3가지를 지정할 수 있다 (기본값: 모두 표시 안함)
     * 예를들어 [‘draw’]로 설정하면 객체를 그릴때 가이드 툴팁이 표시된다
     */
    guideTooltip?: ("draw" | "drag" | "edit")[] | undefined;
    /**
     * 사용할 그리기 요소 지정한다 (기본값: 모든 그리기 요소)
     */
